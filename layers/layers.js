...
var format_ExistedandOpen_3 = new ol.format.GeoJSON();
var features_ExistedandOpen_3 = format_ExistedandOpen_3.readFeatures(json_ExistedandOpen_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ExistedandOpen_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ExistedandOpen_3.addFeatures(features_ExistedandOpen_3);
var lyr_ExistedandOpen_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ExistedandOpen_3, 
                style: style_ExistedandOpen_3,
                popuplayertitle: 'Existed and Open',
                interactive: true,
    title: 'Existed and Open<br />\
    <img src="styles/legend/ExistedandOpen_3_0.png" /> Yes [2950]<br />' });
var format_PermanentlyClosed_4 = new ol.format.GeoJSON();
var features_PermanentlyClosed_4 = format_PermanentlyClosed_4.readFeatures(json_PermanentlyClosed_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PermanentlyClosed_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PermanentlyClosed_4.addFeatures(features_PermanentlyClosed_4);
var lyr_PermanentlyClosed_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PermanentlyClosed_4, 
                style: style_PermanentlyClosed_4,
                popuplayertitle: 'Permanently Closed',
                interactive: true,
    title: 'Permanently Closed<br />\
    <img src="styles/legend/PermanentlyClosed_4_0.png" /> No [15]<br />' });
var group_RestaurantsExistedinTodaysDate = new ol.layer.Group({
                                layers: [lyr_ExistedandOpen_3,lyr_PermanentlyClosed_4,],
                                fold: "open",
                                title: 'Restaurants Existed in Today\'s Date'});

lyr_WorldStreets_0.setVisible(true);lyr_WorldImagery_1.setVisible(true);lyr_EnforcementTowns_2.setVisible(true);lyr_ExistedandOpen_3.setVisible(true);lyr_PermanentlyClosed_4.setVisible(true);
var layersList = [lyr_WorldStreets_0,lyr_WorldImagery_1,lyr_EnforcementTowns_2,group_RestaurantsExistedinTodaysDate];
...
lyr_PermanentlyClosed_4.set('fieldLabels', {'FID_': 'hidden field', 'ID': 'hidden field', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', 'Name': 'inline label - visible with data', 'Address': 'inline label - visible with data', 'hdbscan_cl': 'hidden field', 'reassigned': 'hidden field', 'Tehsil': 'inline label - visible with data', 'UC_Name': 'inline label - visible with data', 'UC_No': 'hidden field', 'Rank': 'hidden field', 'Compliance': 'inline label - visible with data', 'Exists_Nov': 'hidden field', 'Reg_Nov': 'hidden field', 'Exists_Jun': 'hidden field', 'Reg_Jun': 'hidden field', 'Existed': 'inline label - visible with data', 'Town': 'inline label - visible with data', 'Officer_ID': 'inline label - visible with data', 'COMPUTER_N': 'hidden field', 'Branch': 'hidden field', 'NTN': 'inline label - visible with data', 'Filer_June': 'hidden field', 'Filer_May': 'hidden field', 'Tax Payer': 'inline label - visible with data', 'Tax Payer_': 'hidden field', 'Closed_Mul': 'hidden field', 'Multiple_B': 'hidden field', 'Status': 'inline label - visible with data', 'Comments__': 'hidden field', });
lyr_PermanentlyClosed_4.on('precompose', function(evt) {
